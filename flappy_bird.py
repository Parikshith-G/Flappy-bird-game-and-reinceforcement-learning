...
'''above are all the necessary imports'''
...
'''ABOVE ARE ALL THE NECESSARY CONSTANTANTS AND IMAGE IMPORTS'''
...
class Bird:
    ...
    '''above -> again some constants to work with'''
    ...
    '''above-> jumping mechanics vel->-10.5 because point of consideration - > top of screen bird in middle must move towards top of screen -> negative direction'''
    def move(self):
        self.tick_count+=1
